...
function Companies() {
  ...
  const filtered = companies.filter(company =>
    ...
    company.tags.some(tag => tag.toLowerCase().includes(search.toLowerCase()))
  )
  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-3xl font-bold text-white">Hungarian Tech Companies</h2>
          <p className="text-gray-400 mt-1">Select companies to apply to</p>
        </div>
        {selected.length > 0 && (
          <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-xl font-medium transition-colors">
        ...
        {filtered.map(company => {
          ...
          return (
            ...
            >
              ...
              <p className="text-gray-400 text-sm mt-3">{company.description}</p>
